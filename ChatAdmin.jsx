...
function ChatAdmin() {
  ...
  return (
    <div className="min-h-screen gradient-bg-rest p-3 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6 md:mb-8">
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div>
              ...
              <p className="text-white text-xs md:text-sm mt-0.5 md:mt-1">
          ...
          <div className="flex items-center gap-2 md:gap-3 w-full md:w-auto">
            <button
              onClick={toggleAi}
              disabled={aiLoading}
              className={`flex-1 md:flex-none px-3 md:px-6 py-2 md:py-3 rounded-3xl flex items-center justify-center gap-1.5 md:gap-2 text-sm md:text-base border transition-all ${
                aiEnabled
            ...
            <button
              ...
              className="flex-1 md:flex-none bg-purple-500 hover:bg-purple-600 text-white px-3 md:px-6 py-2 md:py-3 rounded-3xl flex items-center justify-center gap-1.5 md:gap-2 text-sm md:text-base"
            >
            ...
            <button
              ...
              className="bg-red-500/20 hover:bg-red-500/30 border border-red-500/50 text-red-400 px-3 md:px-6 py-2 md:py-3 rounded-3xl flex items-center gap-1.5 md:gap-2 text-sm md:text-base"
            >
        ...
        {/* Agents List */}
        <div className="bg-gray-800/50 border border-gray-700 rounded-3xl md:rounded-3xl p-4 md:p-6 mb-6">
              ...
              >
                ...
                <div className="flex items-center gap-2 md:gap-3 w-full sm:w-auto justify-between sm:justify-end">
                  <div className="text-left sm:text-right">
                    <div
                      className={`text-xs md:text-sm ${agent.isOnline ? "text-green-400" : "text-white"}`}
                    >
                  ...
                  <button
                    ...
                    className="p-1.5 md:p-2 hover:bg-red-500/20 rounded-3xl text-red-400 hover:text-red-300"
                  >
        ...
        {/* Customers List */}
        <div className="bg-gray-800/50 border border-gray-700 rounded-3xl md:rounded-3xl p-4 md:p-6">
          <div className="flex items-center justify-between mb-3 md:mb-4">
            ...
            <button
              ...
              className="bg-green-500 hover:bg-green-600 disabled:opacity-50 disabled:cursor-not-allowed text-white px-3 md:px-4 py-2 rounded-3xl flex items-center gap-2 text-sm md:text-base"
            >
          ...
          <div className="space-y-2 md:space-y-3">
              ...
              >
                <div className="flex items-center gap-3 md:gap-4 flex-1">
                  <div className="w-10 h-10 md:w-12 md:h-12 bg-green-500/20 rounded-full flex items-center justify-center flex-shrink-0">
                    <UserCircle
                      size={20}
                      className="text-green-400 md:w-6 md:h-6"
                    />
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
            ...
            {customers.length === 0 && (
              <div className="text-center text-white py-8">
                No customers found. Customers will appear here when they use the
                chat.
              </div>
            )}
          </div>
        ...
        {showCreateForm && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-3 md:p-4 z-50">
            <div className="bg-gray-900 border border-purple-500/30 rounded-2xl md:rounded-3xl p-4 md:p-6 w-full max-w-md">
              ...
              <form onSubmit={handleCreateAgent} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-gray-800 border border-gray-700 text-white px-4 py-3 rounded-3xl focus:outline-none focus:ring-2 focus:ring-purple-500"
                    placeholder="agent1"
                  />
                </div>
                ...
                <div className="flex gap-3 mt-6">
                  <button
                    ...
                    className="flex-1 bg-gray-700 hover:bg-gray-600 text-white py-3 rounded-3xl"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="flex-1 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white py-3 rounded-3xl"
                  >
                    Create Agent
                  </button>
                </div>
